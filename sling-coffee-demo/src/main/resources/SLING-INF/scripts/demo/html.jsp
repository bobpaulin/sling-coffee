...
<body>
	<div>
  	...
  	<div id="coffeeResult">
		<webresource:webresource path="/content/coffee/demo/demo.coffee" shouldInline="true"/>
  	</div>
  	<button onclick="eval(document.getElementById('coffeeResult').children[0].childNodes[0].nodeValue.trim())" >Evaluate</button>
</body>
</html>